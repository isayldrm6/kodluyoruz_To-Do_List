...
function darkMode() {
  ...
  if (document.querySelector("#buttonTheme").innerHTML == " Açık Mod") {
    ...
    document.querySelector("#buttonTheme").className =
      "bi bi-moon btn btn-dark mt-3";
...
function newElement() {
  ...
  if (textbox.value.length > 0) {
    ...
    logo.setAttribute(
      "class",
      "bi bi-trash2-fill text-danger float-right mr-4"
    );
    ...
    check.setAttribute(
      "class",
      "bi bi-check-square-fill text-success float-right mr-4"
    );
